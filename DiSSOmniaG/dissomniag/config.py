...
class dissomniag(ParseSection):
    ...
    def parse(self):
        ...
        self.rsaKeyPrivate = os.path.join(self.configDir, self.parseOption(self.sectionName, "rsaKey", "ssh_key"))
        self.rsaKeyPublic = os.path.join(self.configDir, self.parseOption(self.sectionName, "rsaKeyPub", "ssh_key.pub"))
